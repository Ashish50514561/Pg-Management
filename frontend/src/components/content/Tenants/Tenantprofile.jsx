...
import { asyncGetTenantsById } from "../../../Redux/Actions/tenantAction";
...
export default function Tenantprofile() {
  ...
  useEffect(() => {
    dispatch(asyncGetTenantsById(id));
  }, []);

  return (
    <Grid container item p={{ xs: 1, lg: 2 }} pt={{ xs: 2 }} spacing={0}>
      <Grid item lg={6} borderRadius={3} p={2}>
        <Box pl={{ md: 10, lg: 5 }}>
          <Card sx={{ bgcolor: "#e2e8ed" }} elevation={0}>
            <CardMedia
              sx={{
                borderRadius: "4%",
                width: "100%",
              ...
              image={"success" in tenant ? tenant.success[0].image : null}
              alt="user image.."
            />
            <CardContent sx={{ bgcolor: "#e2e8ed" }}>
              <Stack
                mt={{ lg: 9 }}
                pt={3}
                spacing={1}
      ...
      <Grid
        ...
        pt={0}
      >
        <Stack direction row height="100%" pt={{ xs: 1, md: 0 }}>
          <Box>
            <List>
              ...
              <ListItem aria-label="payment date">
                <ListItemIcon sx={{ minWidth: "35px" }}>
                  <CurrencyRupeeIcon color="primary" />
                </ListItemIcon>
                <ListItemText>
          ...
          <Box aria-label="field-data">
            <List>
              <ListItem aria-label="name">
                <ListItemText>
                  <Typography color="text.secondary" variant="h7">
                    {"success" in tenant ? tenant.success[0].name : "name"}
                  </Typography>
                </ListItemText>
              </ListItem>
              ...
              <ListItem aria-label="email">
                <ListItemText>
                  <Typography color="text.secondary" variant="h7">
                    {"success" in tenant ? tenant.success[0].email : "email"}
                  </Typography>
                </ListItemText>
              </ListItem>
              ...
              <ListItem aria-label="age ">
                <ListItemText>
                  <Typography color="text.secondary" variant="h7">
                    {"success" in tenant ? tenant.success[0].age : "age"}
                  </Typography>
                </ListItemText>
              </ListItem>
              ...
              <ListItem aria-label="adhaar">
                <ListItemText>
                  <Typography color="text.secondary" variant="h7">
                    {"success" in tenant ? tenant.success[0].adhaar : "adhaar"}
                  </Typography>
                </ListItemText>
              </ListItem>
              ...
              <ListItem aria-label="mobile">
                <ListItemText>
                  <Typography color="text.secondary" variant="h7">
                    {"success" in tenant ? tenant.success[0].mobile : "mobile"}
                  </Typography>
                </ListItemText>
              </ListItem>
              ...
              <ListItem aria-label="room">
                <ListItemText>
                  <Typography color="text.secondary" variant="h7">
                    {"success" in tenant
                      ? tenant.success[0].roomNumber
                      : "room"}
                  </Typography>
                </ListItemText>
              </ListItem>

              <ListItem aria-label="paymentstatus">
                <ListItemText>
                  <Typography color="text.secondary" variant="h7">
                    {"success" in tenant
                      ? tenant.success[0].paymentStatus
                      : "payment"}
                  </Typography>
                </ListItemText>
              </ListItem>

              <ListItem aria-label="next payment">
                <ListItemText>
                  <Typography color="text.secondary" variant="h7">
                    {"success" in tenant
                      ? tenant.success[0].paidTill
                      : "payment date"}
                  </Typography>
                </ListItemText>
              </ListItem>
              ...
              <ListItem aria-label="rented on">
                <ListItemText>
                  <Typography color="text.secondary" variant="h7">
                    {"success" in tenant
                      ? tenant.success[0].date.split("T")[0]
                      : "payment date"}
                  </Typography>
                </ListItemText>
              </ListItem>
